...
const PROGRAM_TITLE = "Cosmic Critters";
const PROGRAM_NAME = "game";
const BUILD_FOLDER = "build";
const sourceFiles = ["littlejs.js", "game.js", "index.html", "tiny-brutalism.css"];
const dataFiles = ["animals.png", "ufo.png", "tree2.png"];
...
// copy data files
for (const file of dataFiles) fs.copyFileSync(file, `${BUILD_FOLDER}/${file}`);
...
console.log(
	`Size of ${PROGRAM_NAME}.zip: ${fs.statSync(`${PROGRAM_NAME}.zip`).size} bytes`,
);
